...
var fetchTranslations = async (locale) => {
  switch (locale) {
    ...
    case "en":
    case "en-US":
      return (await import("./en_US-W2WMBJWR.js")).default;
    case "es":
    case "es-419":
    ...
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-EN25J5OB.js")).default;
    case "pt":
    case "pt-BR":
...
var blastIcon = {
  ...
  iconUrl: async () => (await import("./blast-2RNL5ZO7.js")).default
};
var bscIcon = {
...
var klaytnIcon = {
  ...
  iconUrl: async () => (await import("./klaytn-FZEHB43Q.js")).default
};
var optimismIcon = {
...
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-OUC33IWQ.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
...
function useFingerprint() {
  const fingerprint = useCallback2(() => {
    setRainbowKitVersion({ version: "2.0.7" });
  }, []);
  useEffect9(() => {
    fingerprint();
  }, [fingerprint]);
...
import { ChainNotConfiguredError, createConnector as createConnector3 } from "wagmi";
              ...
              params: [
                {
                  ...
                  rpcUrls: [(_b = (_a = chain.rpcUrls.default) == null ? void 0 : _a.http[0]) != null ? _b : ""],
                  blockExplorerUrls: [(_c = chain.blockExplorers) == null ? void 0 : _c.default.url]
                }
              ]
            });
            return chain;
...
var coinbaseWallet2 = ({
  ...
  return {
    ...
    createConnector: (walletDetails) => createConnector4((config) => ({
      ...coinbaseWallet({
        appName,
        appLogoUrl: appIcon,
        headlessMode: true,
